...
import { createCategoryDataFromCategoryModel, createCategoryFromCategoryModel } from '../models/category.model';
    ...
    return this.actions$
      .pipe(
        ...
        mergeMap(() => this.taskManagerService.getAllCategories()
          .pipe(
            map(categoryModels => TaskManagerActions.getAllCategoriesSuccess({
